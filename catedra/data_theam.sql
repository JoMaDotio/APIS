...
INSERT INTO materia (claseNrc, clave, nombre, dias, seccion, cupos, cupDis, edificio, aula, profesor, ciclo, cu)
    VALUES (42268, 'I5884', 'ALGORITMIA', 'M,J', 'D01', 42, 42, 'DEDX', 'A017', 'LUPERCIO CORONEL, RAMIRO', '2020B', 'CUCEI');
INSERT INTO materia (claseNrc, clave, nombre, dias, seccion, cupos, cupDis, edificio, aula, profesor, ciclo, cu)
    VALUES (42269, 'I5884', 'ALGORITMIA', 'M,J', 'D02', 42, 42, 'UNDEF', ' ', 'GARCIA HERNANDEZ MARTIN', '2020B', 'CUCEI');
INSERT INTO materia (claseNrc, clave, nombre, dias, seccion, cupos, cupDis, edificio, aula, profesor, ciclo, cu)
    VALUES (59549, 'I5884', 'ALGORITMIA', 'M,J', 'D06', 42, 42, 'DEDX', 'A003', 'ESPINOZA VALDEZ AURORA', '2020B', 'CUCEI');
INSERT INTO materia (claseNrc, clave, nombre, dias, seccion, cupos, cupDis, edificio, aula, profesor, ciclo, cu)
    VALUES (59829, 'I5884', 'ALGORITMIA', 'M,J', 'D10', 42, 42, 'DEDX', 'A002', 'GOMEZ ANAYA DAVID ALEJANDRO', '2020B', 'CUCEI');
INSERT INTO materia (claseNrc, clave, nombre, dias, seccion, cupos, cupDis, edificio, aula, profesor, ciclo, cu)
    VALUES (140468, 'I5884', 'ALGORITMIA', 'L,I', 'D12', 42, 42, 'DEDX', 'A006', 'RODRIGUEZ ACOSTA, LUIS FERNANDO', '2020B', 'CUCEI');
